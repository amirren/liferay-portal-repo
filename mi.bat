...
mvn install:install-file -DgroupId=datastorm -DartifactId=datastorm -Dversion=1.0.00beta2 -Dfile=datastorm-1.0.00beta2.jar -Dpackaging=jar -DgeneratePom=true -DlocalRepositoryPath=.  -DcreateChecksum=true